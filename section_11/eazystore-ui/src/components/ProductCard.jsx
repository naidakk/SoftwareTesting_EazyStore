    ...
    >
      ...
      <div className="relative h-48 p-4 flex flex-col font-primary">
        ...
        <div className="flex items-center justify-between mt-auto">
          ...
          {/* Add to Cart Button */}
          {/* <button className="bg-primary dark:bg-light hover:bg-dark hover:cursor-pointer dark:hover:bg-lighter text-white dark:text-primary font-medium text-sm py-2 px-4 rounded-md transition">
            Add to Cart
          </button> */}
        </div>
      </div>
